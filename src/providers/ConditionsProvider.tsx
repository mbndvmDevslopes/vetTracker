...
const ConditionsContext = createContext<TConditionsProvider>({} as TConditionsProvider);
...
console.log('conditions from context', conditions)
    return (
        <ConditionsContext.Provider value={{conditions, setConditions, refetchConditions}}>
            {children}
